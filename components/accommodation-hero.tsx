    ...
    <section className="relative pt-32 pb-32 min-h-[70vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Accommodation at Liseli Lodge"
          fill
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Our Accommodations</h1>
          <p className="text-lg md:text-xl">
            Experience comfort and tranquility in our well-appointed rooms and suites, designed for your relaxation.
          </p>
        </motion.div>
      </div>
    </section>
