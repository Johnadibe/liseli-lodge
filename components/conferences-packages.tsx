    ...
    <section className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container">
        <div className="text-center mb-16">
          ...
          >
            Choose from our range of conference packages designed to meet your specific needs and budget.
          </motion.p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground mb-4">Need a custom package for your specific requirements?</p>
